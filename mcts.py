'''
description: Alphago中蒙特卡洛搜索树代码详解
url: https://blog.csdn.net/windowsyun/article/details/88770799
...
class TreeNode(object):
    ...
    # TreeNode
    # 类里初始化了一些数值，主要是
    # 父节点，子节点，访问节点的次数，Q值和u值，还有先验概率。他还定义了一些函数：
    ...
    # 的功能：扩展
    # 输入action_priors
    # 是一个包括的所有合法动作的列表（list），表示在当前局面我可以在哪些地方落子。此函数为当前节点扩展了子节点。
